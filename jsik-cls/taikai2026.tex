...
\subsection{出力形式の評価}
\input{res_output}
\input{tab_hanteiform.tex}

\subsection{判定結果の評価}
\subsubsection{判定者の分類}
\input{bunrui_hanteisya}
\input{fig_cls.tex}
\input{tab_diff.tex}

\subsubsection{判定による修正の程度}
\input{syusei}
\input{tab_countrev.tex}
\input{tab_docs.tex}
\input{figarray_hst.tex}

\subsubsection{どのような地名が抽出・判定されたか}
\input{chimeikettei}
\input{chimeitokutyou}
\input{chimeidaigaku}
\input{tab_dice.tex}
